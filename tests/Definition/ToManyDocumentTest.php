...
{
    public function test_must_serialize_to_many_document_resource(): void
    {
        ...
        self::assertInstanceOf(ToManyDocument::class, $document);
        self::assertSame($serialized, $document->serialize());
        self::assertEquals($document, ToManyDocument::deserialize($serialized));
    }

    public function test_must_serialize_to_many_document_resource_identifier(): void
    {
        $document = ToManyDocument::document()
            ->withData(
                Data::fromResource(
            ...
            ->withLinks(
                Link::self('http://example.com/articles?page[offset]=1&page[limit]=1'),
                Link::first('http://example.com/articles?page[offset]=1&page[limit]=1'),
                Link::prev('http://example.com/articles?page[offset]=1&page[limit]=1'),
                Link::next('http://example.com/articles?page[offset]=1&page[limit]=1'),
                Link::last('http://example.com/articles?page[offset]=1&page[limit]=1'),
                Link::describedby('https://www.example.com/doc')
            );
        ...
        $serialized = [
            ...
            'links' => [
                'self' => 'http://example.com/articles?page[offset]=1&page[limit]=1',
                'first' => 'http://example.com/articles?page[offset]=1&page[limit]=1',
                'prev' => 'http://example.com/articles?page[offset]=1&page[limit]=1',
                'next' => 'http://example.com/articles?page[offset]=1&page[limit]=1',
                'last' => 'http://example.com/articles?page[offset]=1&page[limit]=1',
                'describedby' => 'https://www.example.com/doc',
            ],
            'data' => [
                [
